import { z } from 'zod';
import { acknowledgeDispatch } from '@atlas/scheduling';
...
/** POST /api/v1/jobs/{id}/acknowledge — dispatch-prd.md §11: Technician confirms receipt on their device. */
...
export const POST = withApiHandler<unknown, { params: { id: string } }>(
  async (request, context) => {
    ...
    const event = await acknowledgeDispatch(getDb(), {
