 ...
 * to the current schema. Not run by the default `pnpm test` / CI `test`
 * job — see docs/13-roadmap/SPRINT-7-COMPLETION-REPORT.md for why this
 * suite could not be executed in the environment that wrote it, and run
