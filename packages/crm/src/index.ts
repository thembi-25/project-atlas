/**
 * Customers and Contacts (CRM) domain module for Project Atlas.
 *
 ...
 * their owning sprint.
 *
 * Implementation begins in: Sprint 2 — CRM & Customers
 *
 * Governing documentation:
 * - docs/03-domain/customers.md
 * - docs/03-domain/contacts.md
 * - docs/06-modules/crm-prd.md
 */
